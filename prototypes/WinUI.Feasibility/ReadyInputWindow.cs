...
// Bounded native-editor experiment, not a reusable grid or an adopted input framework.
public sealed class ReadyInputWindow : Window
{
    ...
    {
        private readonly ReadyInputWindow owner;
        ...
        public ReadyCell(ReadyInputWindow owner, int index, TextBlock model)
        {
            this.owner = owner;
            this.model = model;
            Index = index;
