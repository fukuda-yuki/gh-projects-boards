...
Version 5 uses the existing whole-profile checkpoint, serialized save gate and guarded Undo history. Versions 1–4 migrate without discarding Apply attempts, successful/unresolved outcomes, conflicts or pending work. Older writers cannot overwrite the new schema. Repository existence, creation permission, Issue creation, Project addition and returned remote IDs follow the #11 creation contract below.
